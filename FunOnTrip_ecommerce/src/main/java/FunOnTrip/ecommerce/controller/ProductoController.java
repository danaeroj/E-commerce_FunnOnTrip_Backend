...
public class ProductoController {
  ...
  // PATCH /api/productos/{id} (ADMIN) - update parcial general
  @PatchMapping("/{id}")
  ...
  public ResponseEntity<Producto> patchStock(@PathVariable Long id, @RequestBody UpdateStockRequest body) {
    return ResponseEntity.ok(service.actualizarStock(id, body.stock));
  }

  // PATCH /api/productos/{id}/precio (ADMIN)
  @PatchMapping("/{id}/precio")
  public ResponseEntity<Producto> patchPrecio(@PathVariable Long id, @RequestBody UpdatePrecioRequest body) {
  ...
  public static class UpdateStockRequest { public Integer stock; }
  public static class UpdatePrecioRequest { public BigDecimal precio; }
}
